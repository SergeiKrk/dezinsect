...
title_page: Обработка от вшей в Москве
...
faq:
  ...
  faq_list:
    - title: Откуда берутся вши?
      content: "Чаще всего они передаются через прямой физический контакт при соприкасновении голов. Вши не могут прыгать или летать, но могут ползать по волосам, одежде и постельному белью. Эти насекомые могут передаваться через личные предметы: расчески, шапки или наушники. Реже вши могут передаваться в общественных местах, таких как школы, общественный транспорт или кинотеатры."
    - title: Чем можно потравить вшей?
      content: Специализированные аптечные шампуни и мази, содержащие перметрин или пиреметрин, а так же чемеричную воду. Также существуют народные методы, например, обработка головы керосином или дегтярным мылом.
...
- Стиркака при высокой температуре 80-95 градусов Цельсия (при максимально возможной температуре).
- Стиркака с содой или солью. Если вещи нельзя стирать при высокой температуре, в воду рекомендуется добавить соду или поваренную соль.
