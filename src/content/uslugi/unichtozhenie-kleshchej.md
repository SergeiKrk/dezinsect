...
costServices:
  ...
  cost_services_list:
    - scope_work: за сотку
      method: Участок1 сотка
      cost: "4800"
      color: "white"
    - scope_work: 1-комнатная квартира
      method: Горячий туман или мотоопрыскивателя
      cost: "4800"
      color: "[#EDF7F3]"
...
1. **Иксодовый клещ**: хищник, питается кровью животных и человека, может переносить опасные инфекции, такие как энцефалит и болезнь Лайма.
2. **Гамазовый клещ**: обитает на мелких животных, может перейти на человека.
3. **Бурый собачий клещ**: живет на собаках, кошках и мелком рогатом скоте, может переносить пироплазмоз и другие тяжелые заболевания.
4. **Аргасовый клещ**: нападает на мелких животных, птиц и человека, его укус болезненный и вызывает аллергическую реакцию, может переносить бореллиоз и возвратный тиф.
5. **Панцирный клещ**: питается растительными останками и переносит личинки гельминтов.
6. **Пастбищный клещ**: обитает на шкуре крупного рогатого скота, иногда на человеке, и может заразить клещевым энцефалитом, туляремией и листериозом.
7. **Паутинный клещ**: живет на растениях и питается их соком, переносится людьми и животными.
