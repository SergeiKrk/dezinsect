...
costServices:
  title: Примерная стоимость обработки квартиры или дома от короедов
...
- Высокотоксичный дым быстро проникает в древесный материал и ходы жуков, уничтожая врослых особей и их яйца.
